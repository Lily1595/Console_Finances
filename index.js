...
let maxincrease = ["date", 0];
for (let i = 1; i < finances.length; i++) {
    // compare the changes column of finances to the number entry of max increase
    if (finances[i][2] >= maxincrease[1]) {
        // update the date
